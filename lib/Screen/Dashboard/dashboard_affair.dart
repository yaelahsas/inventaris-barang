...
class DashboarAffair extends StatefulWidget {
  const DashboarAffair({Key? key}) : super(key: key);

  @override
  State<DashboarAffair> createState() => _DashboarAffairState();
}

class _DashboarAffairState extends State<DashboarAffair> {
  @override
