...
class LaporanRusakGanti extends StatefulWidget {
  const LaporanRusakGanti({Key? key, required this.barang}) : super(key: key);
  final BarangHilang barang;
  @override
  State<LaporanRusakGanti> createState() => _TambahLaporanGantiState();
}

class _TambahLaporanGantiState extends State<LaporanRusakGanti> {
